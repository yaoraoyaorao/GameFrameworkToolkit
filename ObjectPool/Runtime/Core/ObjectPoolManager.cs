...
namespace GameFramework.Toolkit.Runtime
{
    public sealed partial class ObjectPoolManager : IObjectPoolManager
    {
        ...
        {
            return InternalHasObjectPool(typeof(T).FullName);
        }
        ...
        public bool HasObjectPool(Type objectType)
        {
            ...
            return InternalHasObjectPool(objectType.FullName);
        }
        ...
        {
            string typeName = !string.IsNullOrEmpty(name) ?
                                   typeof(T).FullName + "." + name :
                                   typeof(T).FullName;
            return InternalHasObjectPool(typeName);
        }
        ...
        {
            return (IObjectPool<T>)InternalGetObjectPool(typeof(T).FullName);
        }
        ...
        public ObjectPoolBase GetObjectPool(Type objectType)
        {
            ...
            return InternalGetObjectPool(objectType.FullName);
        }
        ...
        public IObjectPool<T> GetObjectPool<T>(string name) where T : ObjectBase
        {
            string typeName = !string.IsNullOrEmpty(name) ?
                                  typeof(T).FullName + "." + name :
                                  typeof(T).FullName;
            return (IObjectPool<T>)InternalGetObjectPool(typeName);
        }
        ...
        public ObjectPoolBase GetObjectPool(Type objectType, string name)
        {
            ...
            string typeName = !string.IsNullOrEmpty(name) ?
                                 objectType.FullName + "." + name :
                                 objectType.FullName;
            return InternalGetObjectPool(typeName);
        }
        ...
        public bool DestroyObjectPool<T>() where T : ObjectBase
        {
            ...
            return InternalDestroyObjectPool(typeof(T).FullName);
        }
        ...
        public bool DestroyObjectPool(Type objectType)
        {
            ...
            return InternalDestroyObjectPool(objectType.FullName);
        }
        ...
        public bool DestroyObjectPool<T>(string name) where T : ObjectBase
        {
            string typeName = !string.IsNullOrEmpty(name) ?
                               typeof(T).FullName + "." + name :
                               typeof(T).FullName;
            return InternalDestroyObjectPool(typeName);
        }
        ...
        public bool DestroyObjectPool<T>(IObjectPool<T> objectPool) where T : ObjectBase
        {
            ...
            string typeName = !string.IsNullOrEmpty(objectPool.Name) ?
                               typeof(T).FullName + "." + objectPool.Name :
                               typeof(T).FullName;
        ...
        public bool DestroyObjectPool(ObjectPoolBase objectPool)
        {
            ...
            string typeName = !string.IsNullOrEmpty(objectPool.Name) ?
                              objectPool.ObjectType.FullName + "." + objectPool.Name :
                              objectPool.ObjectType.FullName;
        ...
        private bool InternalHasObjectPool(string typeNamePair)
        {
            return m_ObjectPools.ContainsKey(typeNamePair);
        }

        private ObjectPoolBase InternalGetObjectPool(string typeNamePair)
        {
        ...
        private bool InternalDestroyObjectPool(string typeNamePair)
        {
            ObjectPoolBase objectPool = null;
            if (m_ObjectPools.TryGetValue(typeNamePair, out objectPool))
            {
